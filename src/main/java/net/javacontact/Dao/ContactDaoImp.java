...
public class ContactDaoImp implements ContactDao {
	...
	public int save(Contact contact) {
		String sql="INSERT INTO Contact (name,contact_id,email,address,phone) values(?,?,?,?,?)";
		return jdbcTemplate.update(sql,contact.getName(),contact.getId(),contact.getEmail(),contact.getAddress(),contact.getPhone());
